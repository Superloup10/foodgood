export default function Cgv() {
  return (
    <div className="mt-11">
      <h1 className="mt-11 text-5xl">Conditions Générales de Vente</h1>
      <h2 className="mt-11 text-3xl">
        Conditions Générales de Vente F-COMMERCE
      </h2>
      <h3 className="mt-11">PARTIE 1</h3>
      <h4 className="mt-11">LES PARCOURS DE VENTE SUR LE SITE FOODGOOD</h4>
      <div>
        <p className="mt-11">ARTICLE 1.</p>
        <p className="mt-11">
          DEFINITION Dans les présentes conditions générales de vente, les
